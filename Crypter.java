...
*
* Der Eingabetext, der Zeichenweise ubergeben wird ({@literal klarTextZeichen})
* darf nur aus den Gro-Buchstaben A-Z bestehen. Kleinbuchstaben werden in
* Grobuchstaben umgewandelt, alle anderen Zeichen fuhren zu einer Ausnahme.
*
* Zwischen den beiden Methoden muss bei gleichem Schlussel folgendes gelten:
...
*
* @param cypherTextZeichen Zeichen, das entschlusselt werden soll.
1
*
* @return entschlusseltes Zeichen.
* @throws CrypterException Wird geworfen, wenn Probleme mit der
* Verschlusselung auftreten.
*/
